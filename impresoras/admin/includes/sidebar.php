  <div class=" sidebar" role="navigation">
        ...
        <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
          <ul class="nav" id="side-menu">
            ...
            <li>
              <a href="add-services.php"><i class="fa fa-cogs nav_icon"></i>Productos y/o Servicios<span class="fa arrow"></span> </a>
              <ul class="nav nav-second-level collapse">
                <li>
                  <a href="add-services.php">Agregar Producto y/o Servicio</a>
                </li>
                <li>
                  <a href="manage-services.php">Administrar Producto y/o Servicio</a>
                </li>
              </ul>
              <!-- /nav-second-level -->
            </li>
