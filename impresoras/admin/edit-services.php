...
<html>
<head>
<title>IMPRESORAS JAST | ACTUALIZAR PRODUCTOS Y SERVICIOS</title>
	...
	<div class="main-content">
	 ...
	 <?php include_once('includes/header.php');?>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<h3 class="title1">Actualizar Productos y Servicios</h3>
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						<div class="form-title">
							<h4>Actualizar Productos y Servicios Impresoras JAST:</h4>
						</div>
						<div class="form-body">
							<form method="post">
