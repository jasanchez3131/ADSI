        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2 logo">WEB | SERVICIO TÉCNICO DE IMPRESORAS JAST </h2>
              <?php
          ...
          <div class="col-md" style="padding-left: 150px">
             <div class="ftco-footer-widget mb-4">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="services.php" class="py-2 d-block">Productos y Servicios</a></li>
...
?>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p>
  2021 &copy; WEB | SERVICIO TÉCNICO DE IMPRESORAS JAST  </p>
          </div>
        </div>
      </div>
    </footer>