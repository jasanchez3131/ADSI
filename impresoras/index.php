...
<html lang="es">
  <head>
    <title>Servicio Técnico de Impresoras JAST</title>
  ...
  <body>
    ...
    <section id="home-section" class="hero" style="background-image: url(images/pintura.png);" data-stellar-background-ratio="0.5">
	<div class="home-slider owl-carousel">
	      <div class="slider-item js-fullheight">
	      	<div class="overlay"></div>
	        <div class="container-fluid p-0">
	          <div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
	          	<img class="one-third align-self-end order-md-last img-fluid" src="images/tin.png" alt="">
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text mt-5">
		          		<span class="subheading">"Servicios y Productos de Calidad"</span>
			            <h1 class="mb-4">MISIÓN</h1>
			            <p class="mb-4">Contamos con la tecnología y el ánimo de calidad para cumplir Oportunamente con la realización de nuestros servicios.</p>
	          ...
	          <div class="row d-flex no-gutters slider-text align-items-center justify-content-end" data-scrollax-parent="true">
		          ...
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text mt-5">
			            ...
			            <p class="mb-4">Brindar soluciones en servicio técnico y de tecnologías, contribuyendo al desarrollo integro al sector empresarial y humano, brindando soporte técnico eficiente y oportuno.</p>
    	...
    	<div class="container-fluid px-0">
    		<div class="row no-gutters d-md-flex justify-content-end">
    			<div class="one-forth d-flex align-items-end">
    				<div class="text">
    					...
    					<div class="appointment-wrap">
    						<span class="subheading">Elija Producto y/o Servicio</span>
              ...
              ?>
					...
					<div class="one-third">
						<div class="img" style="background-image: url(images/leon.png);">
						</div>
					</div>
    		</div>
    	</div>
